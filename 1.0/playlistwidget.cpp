...
PlayListWidget::PlayListWidget(QWidget *parent):QListWidget(parent), indexInPlayList(-1)
{
...
void PlayListWidget::contextMenuEvent(QContextMenuEvent *menuEvent)
{
    ...
    connect(actionClearValidItem,&QAction::triggered, this, &PlayListWidget::slotActionClearValidItem);
    connect(actionOpen, &QAction::triggered, this, &PlayListWidget::slotActionOpen);
    connect(actionOpenDirectory, &QAction::triggered, this, &PlayListWidget::slotActionOpenDirectory);
    connect(actionPlay, &QAction::triggered, this, &PlayListWidget::slotActionPlay);
...
void PlayListWidget::slotActionOpen()
{
...
//
void PlayListWidget::slotActionDeleteItem()
{
...
void PlayListWidget::slotActionClearValidItem()
{
    emit signalClearValidItem();
}


void PlayListWidget::slotActionClearAll()
{
    emit signalClearAll();
}

void PlayListWidget::slotActionPlay()
{
    QString name;
...
void PlayListWidget::slotActionOpenDirectory()
{
    int count = this->count();
    if(mousePos.y()<count*30)
    {
